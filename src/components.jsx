  ...
  return (
    <nav className={`navbar ${isInner ? 'navbar-inner' : ''}`}>
      <Link to="/" className="nav-brand">
        <img src="/images/logo-custom.png" alt="NewV Tours and Travels Logo" className="brand-logo" />
      </Link>
      ...
      <ul className={`nav-links ${isMobileMenuOpen ? 'active' : ''}`}>
        ...
        <li className="mobile-btn-container">
          <a href="https://wa.me/919840636358?text=Hello%20NewV%20Tours%20and%20Travels!%20I%20would%20like%20to%20plan%20a%20trip." target="_blank" rel="noopener noreferrer" className="btn-primary" onClick={() => setIsMobileMenuOpen(false)}>Whatsapp</a>
        </li>
      </ul>
      <a href="https://wa.me/919840636358?text=Hello%20NewV%20Tours%20and%20Travels!%20I%20would%20like%20to%20plan%20a%20trip." target="_blank" rel="noopener noreferrer" className="btn-primary desktop-btn">Whatsapp</a>
    </nav>
  );
}
